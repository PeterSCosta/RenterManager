...
using RenterManager.Application.Features.DocumentTypes.Commands.Delete;
using RenterManager.Application.Features.DocumentTypes.Queries.Export;
...
namespace RenterManager.Server.Controllers.Utilities.Misc
{
