...
using RenterManager.Application.Features.ExtendedAttributes.Commands.AddEdit;
using RenterManager.Application.Features.ExtendedAttributes.Commands.Delete;
using RenterManager.Application.Features.ExtendedAttributes.Queries.Export;
using RenterManager.Application.Features.ExtendedAttributes.Queries.GetAll;
using RenterManager.Application.Features.ExtendedAttributes.Queries.GetAllByEntityId;
using RenterManager.Application.Features.ExtendedAttributes.Queries.GetById;
using RenterManager.Domain.Contracts;
using Microsoft.AspNetCore.Mvc;

namespace RenterManager.Server.Controllers.Utilities.ExtendedAttributes.Base
{
    /// <summary>
