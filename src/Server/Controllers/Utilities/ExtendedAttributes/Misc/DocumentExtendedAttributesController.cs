...
using RenterManager.Domain.Entities.ExtendedAttributes;
using RenterManager.Domain.Entities.Misc;
using RenterManager.Server.Controllers.Utilities.ExtendedAttributes.Base;
using RenterManager.Shared.Constants.Permission;
using Microsoft.AspNetCore.Authorization;
using Microsoft.AspNetCore.Mvc;

namespace RenterManager.Server.Controllers.Utilities.ExtendedAttributes.Misc
{
