...
using AutoMapper;
using RenterManager.Application.Exceptions;
...
using RenterManager.Infrastructure.Specifications;
using RenterManager.Shared.Constants.Role;
...
namespace RenterManager.Infrastructure.Services.Identity
{
