...
using RenterManager.Client.Infrastructure.Mappings;
using RenterManager.Shared.Constants.Application;
using Microsoft.AspNetCore.Components;
using Microsoft.AspNetCore.SignalR.Client;
using MudBlazor;
using System.Threading.Tasks;
using RenterManager.Client.Infrastructure.Managers.Identity.Roles;
using RenterManager.Shared.Constants.Permission;
using Microsoft.AspNetCore.Authorization;

namespace RenterManager.Client.Pages.Identity
{
